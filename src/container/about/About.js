       ...
       < div className = "about_img_view" >
        ...
        <div className = "about_p_view" >
          ...
          <p className = "about_subtitle" > 
           ...
           They have advantages and disadvantages compared with other 
           approaches. 
           In a few instances, they represent the only reasonable approach. 
           ...
           required wherever possible by European legislation. 
           This article summarizes limitations typical of animal models. However, 
